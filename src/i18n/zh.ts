...
const zh: Record<TranslationKey, string> = {
  ...
  'cli.confirmSaveDesc': '这将覆盖您当前的 ~/.claude-internal/settings.json 文件。确定要继续吗？',
  ...
  'panel.files': '文件',
  'panel.tasks': '任务',
  'panel.agentTeam': 'Agent 团队',
  'panel.openPanel': '打开面板',
  'panel.closePanel': '关闭面板',
  'panel.subagentOutput': 'Subagent 输出',
  'panel.noActiveAgents': '无活跃 Agent',
  'panel.selectAgent': '点击仪表盘中的 Agent 查看其输出',
  'panel.noSubagents': '无活跃子代理',
  'panel.agentRunning': '运行中',
  'panel.agentTotal': '总计',

  // ── Permissions panel ──────────────────────────────────
  'perm.title': '权限规则',
  'perm.autoApproveAll': '自动批准全部',
  'perm.bypassAll': '跳过所有权限检查',
  'perm.autoApproveWarning': '所有工具将在无确认的情况下执行',
  'perm.scopeGlobal': '全局',
  'perm.scopeGlobalDesc': '~/.claude-internal/settings.json · 所有项目',
  'perm.scopeProject': '项目（共享）',
  'perm.scopeProjectDesc': '.claude/settings.json · Git 跟踪',
  'perm.scopeLocal': '项目（本地）',
  'perm.scopeLocalDesc': '.claude/settings.local.json · Git 忽略',
  'perm.scopeSession': '当前会话',
  'perm.sessionHint': '重启后重置',
  'perm.sessionToolHint': '通过权限提示中的「允许一次」批准',
  'perm.revokeAll': '撤销全部',
  'perm.noRules': '未配置规则',
  'perm.rules': '条规则',
  'perm.allow': '允许',
  'perm.deny': '拒绝',
  'perm.allowHint': '工具可以无需确认运行',
  'perm.denyHint': '工具始终被阻止',
  'perm.ruleFormat': '规则格式：工具名(模式)',
  'perm.refreshAll': '刷新所有规则',

...
const en = {
  ...
  'cli.confirmSaveDesc': 'This will overwrite your current ~/.claude-internal/settings.json file. Are you sure you want to continue?',
  ...
  'panel.subagentOutput': 'Subagent Output',
  'panel.noActiveAgents': 'No active agents',
  'panel.selectAgent': 'Click an agent in the dashboard to view its output',
  'panel.noSubagents': 'No subagents active',
  'panel.agentRunning': 'running',
  'panel.agentTotal': 'total',

  // ── Permissions panel ──────────────────────────────────
  'perm.title': 'Permission Rules',
  'perm.autoApproveAll': 'Auto-approve all',
  'perm.bypassAll': 'Bypass all permission checks',
  'perm.autoApproveWarning': 'All tools execute without confirmation',
  'perm.scopeGlobal': 'Global',
  'perm.scopeGlobalDesc': '~/.claude-internal/settings.json · all projects',
  'perm.scopeProject': 'Project (shared)',
  'perm.scopeProjectDesc': '.claude/settings.json · git-tracked',
  'perm.scopeLocal': 'Project (local)',
  'perm.scopeLocalDesc': '.claude/settings.local.json · gitignored',
  'perm.scopeSession': 'This Session',
  'perm.sessionHint': 'resets on restart',
  'perm.sessionToolHint': 'Approved via "Allow Once" in permission prompts',
  'perm.revokeAll': 'Revoke all',
  'perm.noRules': 'No rules configured',
  'perm.rules': 'rules',
  'perm.allow': 'Allow',
  'perm.deny': 'Deny',
  'perm.allowHint': 'tool can run without prompting',
  'perm.denyHint': 'tool is always blocked',
  'perm.ruleFormat': 'Rule format: ToolName(pattern)',
  'perm.refreshAll': 'Refresh all rules',

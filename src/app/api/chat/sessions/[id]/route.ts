...
import { deleteSession, getSession, updateSessionWorkingDirectory, updateSessionTitle, updateSessionMode, updateSessionModel, updateSessionProviderId, clearSessionMessages, updateSdkSessionId, updateSessionPermissionProfile, updateSessionAllowedTools, updateSessionDisallowedTools } from '@/lib/db';
...
export async function PATCH(
  ...
  try {
    ...
    if (Array.isArray(body.allowed_tools)) {
      updateSessionAllowedTools(id, body.allowed_tools);
    }
    if (Array.isArray(body.disallowed_tools)) {
      updateSessionDisallowedTools(id, body.disallowed_tools);
    }
